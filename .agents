...
- Repository Settings: Set Source to "GitHub Actions" in Settings -> Pages
...
## Local Permissions (from .claude/settings.local.json)
- allow: WebSearch
- allow: Bash(uv run mkdocs build:*)
- allow: Bash(mkdir:*)
- allow: Bash(ls:*)
- allow: Read(//Users/rubenayla/Library/CloudStorage/GoogleDrive-ruben.jimenezmejias@gmail.com/My Drive/ruben_files/projects/cyberwheel/**)
